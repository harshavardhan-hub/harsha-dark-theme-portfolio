    ...
    <section id="contact" className="py-32 md:py-48 px-6 md:px-12 lg:px-24 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          <a href="mailto:yanakandlaharshavardhan@gmail.com" className="relative inline-flex items-center justify-center px-8 py-4 bg-zinc-100 text-zinc-950 rounded-full font-medium tracking-wide text-lg hover:bg-zinc-300 transition-colors duration-300 group overflow-hidden">
